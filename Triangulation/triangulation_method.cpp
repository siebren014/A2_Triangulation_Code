...
Matrix trans_scale (const std::vector<Vector2D> &points){
    ...
    // scaling part - average distance of translated points from the centroid
    double dist_sum = 0;
    for (auto &p : points){
    ...
    // transformation matrix: 1st translation, then scaling
    auto trans_and_scale = S_M * T;
//    std::cout << S << std::endl;
//    std::cout << T << std::endl;
//    std::cout << trans_and_scale << std::endl;
...
std::vector<std::vector<Vector2D>> normalize_points( const std::vector<Vector2D> &points_0,const std::vector<Vector2D> &points_1) {
    ...
    //std::cout<<mean_points0<<std::endl;
    //std::cout<<mean_points1<<std::endl;
    ...
    std::cout<<"dis0_norm"<< dis0_norm<<std::endl;
...
bool Triangulation::triangulation(
    ...
    //std::cout<<std:vectorpoints_0_norm<<std::endl;
